...
<head>
  ...
  <meta name="thumbnail" content="<?php echo <?php echo esc_url(get_bloginfo('template_url')); ?> ?>/img/thumbs.png" />
  <!--
  <PageMap>
    <DataObject type="thumbnail">
      <Attribute name="src" value="<?php echo <?php echo esc_url(get_bloginfo('template_url')); ?> ?>/img/thumbs.png"/>
...
-->
  ...
  <script>
    ...
    var theme_url = "<?php echo <?php echo esc_url(get_bloginfo('template_url')); ?> ?>";
