...
<body id="body">
    <div id="scrolltop" class="bgbase wap">
        ...
        <div class="wapper pageWap">
            <div class="pc_only pofixed picIndexMainLxn">
                <figure class="d_flex j_center ali_center picIndexMainFx">
                    <img loading="lazy" src="<?php echo esc_url(get_bloginfo('template_url')); ?>/img/picIndexMainFx.png" alt="<?php bloginfo('name'); ?>" width="803" height="803">
                </figure>
            </div>
