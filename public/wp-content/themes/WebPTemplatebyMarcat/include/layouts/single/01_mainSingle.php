                    ...
                    <li class="liTopNewsLoop">
                        ...
                        <a class="d_flex j_between undernone btnTopNewsLoop" href="<?php echo get_the_permalink($post->ID); ?>">
                            <figure class="iconbtnTopNewsLoop">
                                ...
                                <?php else: ?>
                                    <img loading="lazy" src="<?php echo <?php echo esc_url(get_bloginfo('template_url')); ?> ?>/img/nonthumbs.svg" alt="<?php echo get_the_title($post->ID); ?>" width="<?php echo esc_attr($img[1]); ?>" height="<?php echo esc_attr($img[2]); ?>">
                                <?php endif; ?>
                            </figure>
