<div class="bg_fff singleNewsMainLxn">
    ...
    ?>
    <div class="infoSinglePager">
        <div class="d_flex j_center ali_center pagerTopicsMainSingle">

            <div class="prevSinglePagerWap">
                <?php if ($prev) : ?>
                    <a class="maru d_flex j_between ali_center cl_241A08 fw_400 undernone txtset prevSinglePager" href="<?php echo esc_url(get_permalink($prev->ID)); ?>">
                        ＜ 前の記事
                    </a>
                <?php endif; ?>
            </div>
            ...
            <div class="t_center moreTopicsArchive">
                <a class="cl_241A08 fw_400 txtset undernone btnMoreTopicsArchive" href="<?php echo esc_url(get_category_link(1)); ?>">
            ...
            <div class="nextSinglePagerWap">
                <?php if ($next) : ?>
                    <a class="maru d_flex j_between ali_center cl_241A08 fw_400 undernone txtset nextSinglePager" href="<?php echo esc_url(get_permalink($next->ID)); ?>">
                        次の記事 ＞
                    </a>
                <?php endif; ?>
            </div>
                        ...
                        <a class="d_flex j_between undernone btnTopNewsLoop" href="<?php echo esc_url(get_the_permalink()); ?>">
                            ...
                            <section class="secBtnTopNewsLoop">
                                <div class="d_flex j_start ali_center Mochiy dateTopNewsLoop">
                                    <time class="cl_241A08 Mochiy fw_500 mincho timeTopNewsLoop">
                                        <?php echo esc_html(get_the_date('Y.m.d')); ?>
                                    </time>
                                    <p class="cl_241A08 Mochiy fw_500 mincho catTopNewsLoop">
                                        <?php echo esc_html($nowcats[0]->name ?? ''); ?>
                                    </p>
                                    <?php get_new_flug(get_the_date('Y-m-d')); ?>
                                </div>
