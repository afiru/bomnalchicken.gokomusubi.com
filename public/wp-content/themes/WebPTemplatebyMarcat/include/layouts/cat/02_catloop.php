...
<ul class="d_flex j_between newsTab">
    ...
    <li class="liNewsTab01">
        <a class="undernone cl_fff bg_EC5EA5 btnliNewsTab <?php echo ($cat === 17) ? 'active' : ''; ?>" href="<?php echo esc_url(get_category_link(17)); ?>">
            <?php echo esc_html('ボムカフェ'); ?>
        </a>
    </li>
    <li class="liNewsTab01">
            ...
            <li class="liTopNewsLoop">
                ...
                <a class="d_flex j_between undernone btnTopNewsLoop" href="<?php echo esc_url(get_the_permalink()); ?>">
                    <figure class="iconbtnTopNewsLoop">
                        ...
                        <?php else : ?>
                            <img loading="lazy" src="<?php echo esc_url(get_template_directory_uri() . '/img/nonthumbs.svg'); ?>" alt="<?php echo esc_attr(get_the_title()); ?>" width="60" height="60">
                        <?php endif; ?>
                    </figure>
