    ...
    <div class="mincho infoSinglePager">
        <div class="d_flex j_center ali_center pagerTopicsMainSingle">
            ...
            <div class="prevSinglePagerWap">
                <?php if (!empty($prev)): ?>
                    <a class="maru d_flex j_between ali_center cl_EE952D fw_400 undernone txtset prevSinglePager" href="<?php echo esc_url(get_permalink($prev->ID)); ?>">
                        前のメニュー
                    </a>
                <?php endif; ?>
            </div>
            ...
            <div class="t_center moreTopicsArchive">
                <a class="cl_EE952D fw_400 txtset undernone btnMoreTopicsArchive" href="<?php echo esc_url(home_url('/menu/')); ?>">
            ...
            <div class="nextSinglePagerWap">
                <?php if (!empty($next)): ?>
                    <a class="maru d_flex j_between ali_center cl_EE952D fw_400 undernone txtset nextSinglePager" href="<?php echo esc_url(get_permalink($next->ID)); ?>">
                        次のメニュー
                    </a>
                <?php endif; ?>
            </div>
