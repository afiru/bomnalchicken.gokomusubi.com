                ...
                <a class="d_flex j_between undernone btnTopNewsLoop" href="<?php echo esc_url(get_the_permalink()); ?>">
                    ...
                    <section class="secBtnTopNewsLoop">
                        <div class="d_flex j_start ali_center dateTopNewsLoop">
                            <time class="cl_241A08 fw_500 mincho timeTopNewsLoop"><?php echo esc_html(get_the_date('Y.m.d')); ?></time>
                            <p class="cl_241A08 fw_500 mincho catTopNewsLoop"><?php echo esc_html($nowcats[0]->name ?? ''); ?></p>
