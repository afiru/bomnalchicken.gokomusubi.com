<div class="bg_A01D10 snsFooter" data-lenis-prevent>
    <div class="d_flex j_between ali_center snsFooterLxn">
        <div class="d_flex j_between btnSnsFooterLxn">
            <a class="d_flex j_center ali_center bg_282828 cl_fff fw_800 kaisei btnSnsFooter" href="<?php echo scf::get('urlGoogleMap', 32); ?>" target="_blank">
                ナビを起動
            </a>
            <a class="d_flex j_center ali_center bg_282828 cl_fff fw_800 kaisei btnSnsFooter" href="https://liff.line.me/1645278921-kWRPP32q/?accountId=048mzzer" target="_blank">
                ご予約
            </a>
        </div>
