                    ...
                    <div class="swiper-slide">
                        <a href="<?php echo esc_url($link); ?>" target="_blank" rel="noopener noreferrer">
                            <?php if (strtolower($ext) === 'mp4') : ?>
                                <video class="my-video" muted autoplay playsinline preload="metadata" style="width:100%;">
                                    <source src="<?php echo esc_url($file_url); ?>" type="video/mp4">
                                    <?php echo esc_html('お使いのブラウザは動画タグに対応していません。'); ?>
                                </video>
                            <?php else : ?>
                                <img src="<?php echo esc_url($file_url); ?>" alt="<?php echo esc_attr(get_the_title()); ?>" style="width:100%;">
                            <?php endif; ?>
                        </a>
                    </div>
                <?php } ?>
