...
<?php if ($faq_posts) : ?>
<div id="faq" class="bg_fff faqIndex">
    <!--bg:../img/faq.png-->
    <div class="priceLxn faqIndexLxn">
        <section class="titleTopPrice">
            ...
            <p class="cl_E9483E fw_800 en ryshyadow rybyTopPrice"><?php echo esc_html('FAQ'); ?></p>
        </section>
            ...
            <li class="liFaq">
                <div class="bg_FBEBEC btnFaq jsbtnFaq off">
                    <section class="d_flex j_between ali_center jsbtnFaqFx btnFaqFx off">
                        <h2 class="cl_EB53A2 fw_800 h2btnFaq"><?php echo esc_html(get_the_title($post->ID)); ?></h2>
